...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_3(
        LT(3,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, LCTL_T(KC_BSPC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_LSFT), LALT_T(KC_ESC), TT(2), LCTL_T(KC_SPC), LCTL_T(KC_ENT), TT(3), RGUI_T(KC_DEL)
    ),
    ...
    [_NUM] = LAYOUT_split_3x6_3(
        KC_GRV, KC_NO, LCTL(KC_LEFT), KC_UP, LCTL(KC_RIGHT), KC_PGUP, KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_PAST, KC_TRNS, LCAG(KC_NO), KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, KC_PMNS, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_PSLS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_HOME, KC_END, KC_P0, KC_P1, KC_P2, KC_P3, KC_PDOT, KC_PEQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_FN), KC_TRNS
    ),
