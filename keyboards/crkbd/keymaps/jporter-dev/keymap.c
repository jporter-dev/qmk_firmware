...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_split_3x6_3(
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_PEQL, KC_TRNS, KC_NO, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_NO, KC_P4, KC_P5, KC_P6, KC_PPLS, KC_PAST, KC_TRNS, LCAG(KC_NO), KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_PDOT, KC_P1, KC_P2, KC_P3, KC_PMNS, KC_PSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_0
    ),
